...
```json
{
  ...
  "subQuestions": [
    {
      "content": "<p>汉服，是汉民族的传统服装，又称______。</p>",
      "type": "填空",
      "answer": {"blanks": ["略"]}
    },
    {
      "content": "<p>根据录音内容判断对错，对的打"√"，错的打"×"。</p><p>1.唐代服饰用色浓烈大方。______</p><p>2.宋代汉服完全一样。______</p><p>3.汉服回归现代生活。______</p>",
      "type": "判断",
...
```json
{
  ...
  "subQuestions": [
    ...
    {
      "content": "<p>根据录音内容判断对错，对的打“√”，错的打“×”。唐代服饰用色浓烈大方，呈现出雍容华美的特点。______</p>",
      "type": "判断",
      "answer": {"choice": "1"},
      "solution": "<p>本题考查对录音内容的理解和判断能力。</p>"
    },
    {
      "content": "<p>宋代汉服在形制设计和风格上同唐代汉服完全一样。______</p>",
      "type": "判断",
      "answer": {"choice": "0"},
      "solution": "<p>本题考查对录音内容的理解和判断能力。</p>"
    },
    {
      "content": "<p>有人认为，让汉服回归现代生活才是对其最好的保护与传承。______</p>",
      "type": "判断",
      "answer": {"choice": "1"},
      "solution": "<p>本题考查对录音内容的理解和判断能力。</p>"
    }
...
**判断题一致性检查**：
- ✅ type="判断" → content中的 `______` 保持原样，不转换为 `<input>` 标签
...
- [ ] **层级结构检查**：JSON的顶层应该包含`subjectId`、`phaseId`、`question`、`subQuestions`（如果有）
